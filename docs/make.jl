...
using TidierData, DataFrames, PalmerPenguins, TidierPlots

DocTestMeta = quote
    using TidierPlots, DataFrames, Chain, Statistics
end
DocMeta.setdocmeta!(TidierPlots,
    :DocTestSetup,
    DocTestMeta;
    recursive=true)
makedocs(
...
deploydocs(; devurl="latest", repo="https://github.com/TidierOrg/TidierPlots.jl", push_preview=true,
